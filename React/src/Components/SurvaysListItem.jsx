...
export default function SurvaysListItem({survay ,onDeleteClick,img}) {
  return (
    <div className="flex flex-col py-6 px-6 shadow-md bg-white hover:bg-gray-50 h-[400px] rounded-lg">
      <img src={survay.image_url} alt={survay.title} className="w-full h-48  object-cover rounded-md" />
      ...
      <div className="flex justify-between items-center mt-3">
        ...
        <div className="flex items-center">
          ...
          {survay.id && (
            <TButton onClickEvent={ev => onDeleteClick(survay.id)} circle link color="red">
